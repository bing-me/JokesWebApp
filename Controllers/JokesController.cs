...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuestion,JokePunchline")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuestion,JokePunchline")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
